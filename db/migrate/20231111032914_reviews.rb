class Reviews < ActiveRecord::Migration[7.1]
  def change
    ...
    unless table_exists?(:reviews)
      create_table :reviews do |t|
        ...
        # create 'reviewer' and 'reviewee' columns as references to the 'users' table
        # these act as foreign keys to link reviews to the users who wrote them and users who received them
